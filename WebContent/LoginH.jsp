...
<body>
	...
	<div class="form-group w-50">
		...
		<form id="formHospitalLogin"
			class="text-center border border-light p-5" action="HospitalLoginAPI"
			method="post">
			<p class="h4 mb-4">Hospital Sign in</p>
			...
			<p>
				Not a member?<a href="Hospital.jsp">Register</a>
			</p>
		</form>
	</div>
</body>
