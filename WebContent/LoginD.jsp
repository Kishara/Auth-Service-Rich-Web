...
<body>
	...
	<div class="form-group w-50">
		...
		<form id="formDoctorLogin" class="text-center border border-light p-5"
			action="DoctorLoginAPI" method="post">
			<p class="h4 mb-4">Doctor Sign in</p>
			...
			<p>
				Not a member?<a href="Doctor.jsp">Register</a>
			</p>
		</form>
	</div>
</body>
